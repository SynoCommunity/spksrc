...
postinst ()
{
    ...
    ${INSTALL_DIR}/env/bin/pip install -I -r ${INSTALL_DIR}/share/OctoPrint/requirements.txt > /dev/null 2>&1

    # Create device
    test -e /dev/usb/ttyACM0 || mknod /dev/usb/ttyACM0 c 166 0
    chmod 777 /dev/usb/ttyACM0
