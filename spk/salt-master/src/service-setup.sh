...
service_postinst ()
{
    ...
    test -f ${SYNOPKG_PKGDEST}/env/etc/salt/master.d/03_logging.conf || echo "log_file: ${SYNOPKG_PKGVAR}/${SYNOPKG_PKGNAME}.log" > ${SYNOPKG_PKGDEST}/env/etc/salt/master.d/03_logging.conf
