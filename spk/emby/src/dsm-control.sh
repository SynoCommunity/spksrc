...
PID_FILE="${DATA_DIR}/emby.pid"

COMMAND="env PATH=${MONO_PATH}:${PATH} LD_LIBRARY_PATH=${EXTRA_LIBS} ${MONO} -- ${EXE_FILE} -programdata ${DATA_DIR} -ffmpeg ${FFMPEG}/ffmpeg -ffprobe ${FFMPEG}/ffprobe"
