...
# Package
PACKAGE="maraschino-custom"
DNAME="maraschino-custom"
...
start_daemon ()
{
    su - ${USER} -c "PATH=${PATH} ${PYTHON} ${MARASCHINO} --daemon --port 8262 --pidfile ${PID_FILE} --database ${DB_FILE} --log ${LOG_FILE}"
}
