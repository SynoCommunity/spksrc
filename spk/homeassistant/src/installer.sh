...
postinst ()
{
    ...
    # Install the wheels
    ${INSTALL_DIR}/env/bin/pip3.4 install --use-wheel --no-deps --no-index --force-reinstall -f ${INSTALL_DIR}/share/wheelhouse -r ${INSTALL_DIR}/share/wheelhouse/requirements.txt > /dev/null 2>&1
