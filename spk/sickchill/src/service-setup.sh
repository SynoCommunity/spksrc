...
SC_CONFIG_GIT_BRANCH=master
SC_CONFIG_GIT_COMMIT_HASH=2190ef19c06b27911c01e04d5310220bcd6ac929
SC_CONFIG_GIT_COMMIT_BRANCH=v2020.09.28-2
...
branch = ${SC_CONFIG_GIT_BRANCH}
cur_commit_hash = ${SC_CONFIG_GIT_COMMIT_HASH}
cur_commit_branch = ${SC_CONFIG_GIT_COMMIT_BRANCH}
EOF
    fi
}
