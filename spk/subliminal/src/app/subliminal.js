            ...
            items: [{
                ...
                items: [{
                    ...
                    store: new Ext.data.ArrayStore({
                        fields: ["alpha2", "name"],
                        data: [["aa", "Afar"], ["ab", "Abkhazian"], ["af", "Afrikaans"], ["ak", "Akan"], ["sq", "Albanian"],
                               ["am", "Amharic"], ["ar", "Arabic"], ["an", "Aragonese"], ["hy", "Armenian"], ["as", "Assamese"],
                               ["av", "Avaric"], ["ae", "Avestan"], ["ay", "Aymara"], ["az", "Azerbaijani"], ["ba", "Bashkir"],
                               ["bm", "Bambara"], ["eu", "Basque"], ["be", "Belarusian"], ["bn", "Bengali"], ["bi", "Bislama"],
                               ["bs", "Bosnian"], ["br", "Breton"], ["bg", "Bulgarian"], ["my", "Burmese"], ["ch", "Chamorro"],
                               ["ce", "Chechen"], ["zh", "Chinese"], ["cv", "Chuvash"], ["kw", "Cornish"], ["co", "Corsican"],
                               ["cr", "Cree"], ["cs", "Czech"], ["da", "Danish"], ["dz", "Dzongkha"], ["en", "English"],
                               ["eo", "Esperanto"], ["et", "Estonian"], ["ee", "Ewe"], ["fo", "Faroese"], ["fj", "Fijian"],
                               ["fi", "Finnish"], ["fr", "French"], ["ff", "Fulah"], ["ka", "Georgian"], ["de", "German"],
                               ["ga", "Irish"], ["gl", "Galician"], ["gn", "Guarani"], ["gu", "Gujarati"], ["ha", "Hausa"],
                               ["he", "Hebrew"], ["hz", "Herero"], ["hi", "Hindi"], ["hr", "Croatian"], ["hu", "Hungarian"],
                               ["ig", "Igbo"], ["is", "Icelandic"], ["io", "Ido"], ["iu", "Inuktitut"], ["id", "Indonesian"],
                               ["ik", "Inupiaq"], ["it", "Italian"], ["jv", "Javanese"], ["ja", "Japanese"], ["kn", "Kannada"],
                               ["ks", "Kashmiri"], ["kr", "Kanuri"], ["kk", "Kazakh"], ["rw", "Kinyarwanda"], ["kv", "Komi"],
                               ["kg", "Kongo"], ["ko", "Korean"], ["ku", "Kurdish"], ["lo", "Lao"], ["la", "Latin"],
                               ["lv", "Latvian"], ["ln", "Lingala"], ["lt", "Lithuanian"], ["lg", "Ganda"], ["mk", "Macedonian"],
                               ["mh", "Marshallese"], ["ml", "Malayalam"], ["mi", "Maori"], ["mr", "Marathi"], ["ms", "Malay"],
                               ["mg", "Malagasy"], ["mt", "Maltese"], ["mn", "Mongolian"], ["na", "Nauru"], ["ng", "Ndonga"],
                               ["ne", "Nepali"], ["no", "Norwegian"], ["oj", "Ojibwa"], ["or", "Oriya"], ["om", "Oromo"],
                               ["fa", "Persian"], ["pi", "Pali"], ["pl", "Polish"], ["pt", "Portuguese"], ["qu", "Quechua"],
                               ["rm", "Romansh"], ["rn", "Rundi"], ["ru", "Russian"], ["sg", "Sango"], ["sa", "Sanskrit"],
                               ["sk", "Slovak"], ["sl", "Slovenian"], ["sm", "Samoan"], ["sn", "Shona"], ["sd", "Sindhi"],
                               ["so", "Somali"], ["sc", "Sardinian"], ["sr", "Serbian"], ["ss", "Swati"], ["su", "Sundanese"],
                               ["sw", "Swahili"], ["sv", "Swedish"], ["ty", "Tahitian"], ["ta", "Tamil"], ["tt", "Tatar"],
                               ["te", "Telugu"], ["tg", "Tajik"], ["tl", "Tagalog"], ["th", "Thai"], ["bo", "Tibetan"],
                               ["ti", "Tigrinya"], ["tn", "Tswana"], ["ts", "Tsonga"], ["tk", "Turkmen"], ["tr", "Turkish"],
                               ["tw", "Twi"], ["uk", "Ukrainian"], ["ur", "Urdu"], ["uz", "Uzbek"], ["ve", "Venda"],
                               ["vi", "Vietnamese"], ["vo", "Volapük"], ["cy", "Welsh"], ["wa", "Walloon"], ["wo", "Wolof"],
                               ["xh", "Xhosa"], ["yi", "Yiddish"], ["yo", "Yoruba"], ["zu", "Zulu"], ["pb", "Portuguese (Brazil)"]],
                        sortInfo: {
                            field: "name",
                            direction: "ASC"
                        }
