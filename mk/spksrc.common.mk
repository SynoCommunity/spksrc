...
# How a switch declared above reaches a sub-make -- AFTER every declaration, BEFORE the
# first crossing, which is stage0's.
include $(BASEDIR)/mk/spksrc.common/forward.mk
