...
CFLAGS += -I$(WORK_DIR)/$(TC_PREFIX)/$(TC_INCLUDE) $(TC_EXTRA_CFLAGS)
CFLAGS += -I$(INSTALL_DIR)/$(INSTALL_PREFIX)/include

CPPFLAGS += -I$(WORK_DIR)/$(TC_PREFIX)/$(TC_INCLUDE) $(TC_EXTRA_CFLAGS)
CPPFLAGS += -I$(INSTALL_DIR)/$(INSTALL_PREFIX)/include

CXXFLAGS += -I$(WORK_DIR)/$(TC_PREFIX)/$(TC_INCLUDE) $(TC_EXTRA_CFLAGS)
CXXFLAGS += -I$(INSTALL_DIR)/$(INSTALL_PREFIX)/include

LDFLAGS += -L$(WORK_DIR)/$(TC_PREFIX)/$(TC_LIBRARY) $(TC_EXTRA_CFLAGS)
