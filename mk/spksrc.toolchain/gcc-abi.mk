...
_GCC_ABI_BASE = $(if $(_GCC_ABI_CPU),\
                  ...
                  $(_GCC_ABI_ARCH))
# keep the stock fpu, else default neon for hard-float 32-bit ARM
...
GCC_TARGET_ABI = $(strip $(_GCC_ABI_BASE) $(_GCC_ABI_FLOAT) $(_GCC_ABI_FPU2) $(_GCC_ABI_E500) $(_GCC_ABI_OBS))
