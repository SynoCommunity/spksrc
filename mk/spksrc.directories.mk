...
INSTALL_NONTARGET_PREFIX = /..
endif
endif
INSTALL_PREFIX_ETC  = $(INSTALL_PREFIX)$(INSTALL_NONTARGET_PREFIX)/etc
INSTALL_PREFIX_VAR  = $(INSTALL_PREFIX)$(INSTALL_NONTARGET_PREFIX)/var
INSTALL_PREFIX_TMP  = $(INSTALL_PREFIX)$(INSTALL_NONTARGET_PREFIX)/tmp
INSTALL_PREFIX_HOME = $(INSTALL_PREFIX)$(INSTALL_NONTARGET_PREFIX)/home

ifeq ($(strip $(STAGING_DIR)),)
STAGING_DIR = $(WORK_DIR)/staging
endif
ifeq ($(call version_ge, ${TCVERSION}, 7.0),1)
STAGING_SPKETC  = $(STAGING_DIR)/_etc
STAGING_SPKVAR  = $(STAGING_DIR)/_var
STAGING_SPKTMP  = $(STAGING_DIR)/_tmp
STAGING_SPKHOME = $(STAGING_DIR)/_home
else
STAGING_SPKETC  = $(STAGING_DIR)/etc
