...
# - ffmpeg, ffmpeg5 and ffmpeg6 are not cleaned to be available for dependents.
# - Therefore ffmpeg, ffmpeg5 and ffmpeg6 are built first if triggered by its
...
# Build
PACKAGES_TO_KEEP="ffmpeg ffmpeg5 ffmpeg6"
